...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const userr = new MessageEmbed()
      ...
      .setThumbnail("https://assets.lighthouselabs.ca/logos/Lighthouse.png")
    ...
    const dm = new MessageEmbed()
      ...
      .setTitle("Thank you!")
      .setDescription(
        "Thank you for posting this report. This helps us monitor and keep our bot clean and working! Have a good day!"
      )
      .setColor("#2F3136")
      .setFooter({
